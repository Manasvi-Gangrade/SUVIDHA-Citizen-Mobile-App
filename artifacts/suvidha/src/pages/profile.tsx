        ...
        <div className="px-4 py-4 space-y-3">
          ...
          <div className="bg-suvidha-navy rounded-2xl p-5 flex items-center gap-4 shadow-sm">
            ...
            <div className="flex-1">
              <h2 className="font-heading font-bold text-lg text-white">{PROFILE_DATA.name}</h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
            ...
            <div className="font-mono text-base font-bold tracking-widest text-gray-800">{PROFILE_DATA.aadhaar}</div>
          </div>
