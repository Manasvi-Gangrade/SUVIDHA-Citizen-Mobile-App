...
export default function NewGrievance() {
  ...
  const [ticketId] = useState(`SVD-${Math.floor(1000 + Math.random() * 9000)}`);
            ...
            {step === 2 && (
              <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea placeholder="Describe the issue clearly..." className="min-h-[100px] bg-white rounded-xl resize-none" />
                </div>
              ...
              <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-4">
                ...
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm divide-y divide-gray-100">
                  {[
                    ...
                    { label: "Location",   value: "Near Community Center, Sec 4" },
                    { label: "Description", value: "The street light pole no. 45 has been non-functional for 3 days." },
                  ].map(row => (
